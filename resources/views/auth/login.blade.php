@extends('layouts.app', ['pageTitle' => 'Login Page'])
    ...
    <div class="w-100 d-flex justify-content-center">
        <form class="form_container" action="{{route('login')}}" method="POST">
            ...
            <div class="input_container">
                ...
                <input placeholder="name@mail.com" title="Inpit title" id="email_field" name="email" type="email"
                       class="input_field {{$errors->has('email') ? 'has-danger':''}}" value="{{old('email')}}">
            </div>
            @include('components.form-control-feedback', [ 'field' => 'email' ])
            <div class="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="password" type="password"
                       class="input_field {{$errors->has('password') ? 'has-danger':''}}" id="password_field">
            </div>
            @include('components.form-control-feedback', [ 'field' => 'password' ])
